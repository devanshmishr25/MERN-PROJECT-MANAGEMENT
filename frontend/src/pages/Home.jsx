...
const Home = () => {
  ...
  useEffect(() => {
    document.title = authState.isLoggedIn ? `${authState.user.name}'s tasks` : "Project Manager";
  }, [authState]);
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-gray-100 h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Welcome to Project Manager App</h1>
